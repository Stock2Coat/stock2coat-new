-- Migration: Add atomic consumption function for inventory management
-- Created: 2025-07-16
-- Purpose: Enable atomic consumption transactions with proper error handling
...
CREATE POLICY "Users can execute consumption transactions" ON inventory_items
FOR UPDATE
TO authenticated
USING (true);
